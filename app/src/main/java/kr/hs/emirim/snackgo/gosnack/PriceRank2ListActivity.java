 ...
 */
public class PriceRank2ListActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_price_rank2_list);
        ...
        myadapter = new SnackAdapter(getApplicationContext(),R.layout.activity_price_rank2_list_item, h_info_list);
